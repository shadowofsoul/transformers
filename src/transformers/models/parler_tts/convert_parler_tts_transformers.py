...
from transformers.models.parler_tts.modeling_parler_tts import ParlerTTSForCausalLM
...
def convert_parler_tts_checkpoint(
    ...
    model = ParlerTTSForConditionalGeneration(text_encoder=text_encoder, audio_encoder=audio_encoder, decoder=decoder)
    ...
    processor = ParlerTTSProcessor(feature_extractor=feature_extractor, tokenizer=tokenizer)

    # set the appropriate bos/pad token ids
    model.generation_config.decoder_start_token_id = 1025
    model.generation_config.pad_token_id = 1024
